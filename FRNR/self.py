...
cl = PUY.LINE()
#cl.login(qr=True)
cl.login(token="Etvg8nHiTJxI09l0Crda.NIUXBR7Mi450qqY+cR9uUG.3gs8Kh5GcXOa/E4v9pSDEShUHPIWppVgdxBrtxedFm0=")
cl.loginResult()
...
Bots=[mid]
admin=["u9e2bb16ebee6238e74410cbf0abf54ba"]
    ...
    try:
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = ["",cName + " what ?, ", cName + " Kenapa? pc dia aja klo penting,  " + cName + "?", "Ada Perlu apa Sem?, " + cName + "?","Hmm?, ", "Jgn tag tag ah, "]
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': "u9e2bb16ebee6238e74410cbf0abf54ba',"}
                cl.sendMessage(msg)
...
#==============================================#
        ...
        if op.type == 17:
          ...
          random.choice(KAC).sendText(op.param1, "Selamat Datang/nCek note dan slamat Menikmati tikungan tajam ya..😁 .")
          print "MEMBER HAS JOIN THE GROUP"
        if op.type == 15:
          if op.param2 in Bots:
             return
          random.choice(KAC).sendText(op.param1, "Slamat jalan/nMahluk Goib knpa kabur?? baper ya/nkaya denis ajah baperan 😁")
